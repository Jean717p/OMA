...
public:
    ...
    void cellByCell(double tStart,double outOfTime,int dimDestArray,int tId,int predefinedTaskCount,int cicloN);

    void democratic(double tStart,double outOfTime,int dimDestArray,int tId,int predefinedTaskCount,int cicloN);
